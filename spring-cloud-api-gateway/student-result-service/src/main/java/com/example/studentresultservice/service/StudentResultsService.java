package com.example.studentresultservice.service;
...
import com.example.studentresultservice.model.Marks;
...
public class StudentResultsService {
    ...
    @HystrixCommand(fallbackMethod="getDefaultMarks")
    ...
    private Marks getDefaultMarks(int id) {
