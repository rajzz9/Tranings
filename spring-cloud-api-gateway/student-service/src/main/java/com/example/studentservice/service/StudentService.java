...
import com.example.studentservice.util.RestConnector;
...
public class StudentService {
	...
	@HystrixCommand(fallbackMethod = "defaultStudent", commandKey = "StudentDeatilsWithMArks", groupKey = "Student-Service", commandProperties = {
